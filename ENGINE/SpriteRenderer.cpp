...
SpriteRenderer::SpriteRenderer() : mesh(nullptr), constBuffer(nullptr), 
...
void SpriteRenderer::Render(const My_Ptr<Camera>& _Camera)
{
	UpdateTransform();
...
void SpriteRenderer::SetBlender(std::wstring _Name)
{
